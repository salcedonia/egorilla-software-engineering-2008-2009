...
public class MiTest {
  ...
  public static void main(String[] args) throws IllegalAccessException, NoSuchFieldException{
    ...
    Field f1, f2;
    f1 = GestorDisco.class.getDeclaredField( "_directorioTemporales" );
    f2 = GestorDisco.class.getDeclaredField( "_directorioCompletos" );
    f1.setAccessible( true );
    f2.setAccessible( true );
    String _directorioTemporalesGes = (String) f1.get( gestorDisco );
    String _directorioCompletosGes = (String) f2.get( gestorDisco );
    _directorioTemporalesGes = directorioTest+_directorioTemporalesGes;
    _directorioCompletosGes = directorioTest+_directorioCompletosGes;
    ...
    File fileTemp = new File( gestorDisco.getDirectorioTemporales()+"//"+nombreFileComJar+
        ".tmp" );
    //No hace falta comprobarlo, pero casi en un 99% el hash debe ser diferente
    String hashTemp = MD5Sum.getFileMD5Sum( fileTemp );
    //hashTemp es el hash del archivo temporal en cada momento, es decir, cambiara en funcion 
    //de los fragmentos, hasta tener todos, qentonces coincidira con el iriginal
    ...
    File filePeli = new File( directorioTest+nombreFilePeli );
