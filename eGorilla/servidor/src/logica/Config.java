 ...
 * Se leerá a partir de un fichero de configuración y será accesible allá donde 
 * sea necesario.
 * 
 * Una vez inicializado se podrán leer todos los campos en cualquier �mbito 
...
//	*****************************************************************************//
     ...
     * @throws IOException Se lanza en caso de no encontrar el fichero de 
...
//	*****************************************************************************//
    /**
     * Devuelve la versión de la peticion que se está utilizando.
     * 
     * @return La versión de la petición que se está utilizando.
     */
