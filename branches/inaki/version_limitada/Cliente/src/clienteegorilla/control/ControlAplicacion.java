...
public class ControlAplicacion {
     ...
     */
    /*CAMBIADO DEL VOID A ...*/
    public static RespuestaPeticionDescarga bajar(String hash,String nombreArchivo){
        ...
        if (respuestaDescarga != null) {
            Descarga d = new Descarga(respuestaDescarga, hash, nombreArchivo);
            d.start();
            //try {
                //Espera a que termine el hilo de descarga. Ahora no falla br de ClienteTest tras la opción 4
                //Pero es una solución mala, pues las descargas deben ser concurrentes 
                //d.join();
