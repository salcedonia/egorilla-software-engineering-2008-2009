package servidoregorilla.servidor;
...
import servidoregorilla.tareas.*;
    ...
    public synchronized void procesarDatosRecibidos(Peticion peticion, ConexionCliente conn) throws IOException {
        ...
        switch (peticion.getVersion()) {
            ...
            case 2:
                ...
                ProcesarPeticionConsulta procesarConsulta = new ProcesarPeticionConsulta( _archivoClientes, (PeticionConsulta) peticion, conn );
