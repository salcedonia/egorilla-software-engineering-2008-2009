...
public class Descarga extends Thread{
    ...
    public Descarga(RespuestaPeticionDescarga respuestaDescarga, String deseado){
    ...
    public void run(){
        ...
        int puerto;
          ...
          //Luego esto no deberia cumplirse nunca
            ...
            FileChunk escritorFicheroCachos = new FileChunk( _directorio, "ficheroDescargado"+_deseado, _deseado );
